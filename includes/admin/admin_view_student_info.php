...
<head>
    ...
    <title>GJC EduPay - View Student</title>
        ...
        <div class="container admin-container">
            ...
            <div class="admin-top-row">
                <div class="admin-title-group">
                    ...
                    <p class="admin-page-subtitle">View student information</p>
                </div>
            ...
            <div class="admin-table-shell">
                <div class="admin-table-head">
                    <div>
                        ...
                        <p class="admin-table-subtitle">Read-only details of the student</p>
                    </div>
                </div>
