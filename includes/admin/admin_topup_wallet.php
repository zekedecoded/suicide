...
<head>
    ...
    <title>Top-Up Student Wallet</title>
...
<body class="admin-body">
    ...
    <div class="admin-wrapper">
        <div class="container admin-container">
            ...
            <!-- TITLE -->
            <div class="mb-4">
                <h4 class="fw-bold">← Top-Up Student Wallet</h4>
            </div>

            <!-- FIND STUDENT -->
            <div class="admin-table-shell mb-4">
                <label class="admin-form-label">Find Student</label>

                <div class="d-flex gap-2 mt-2">
                    <input type="text" class="form-control admin-form-input" placeholder="Enter Student ID">
